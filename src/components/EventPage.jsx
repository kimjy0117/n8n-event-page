  ...
  return (
    <div className="event-container" style={{ maxWidth: '480px', margin: '40px auto', padding: '25px', textAlign: 'center', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", background: '#fff', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)' }}>
      <div className="hero-section">
        <h1 className="hero-title" style={{ fontSize: '2.5rem', fontWeight: '700', color: '#f47c20', marginBottom: '15px', textShadow: '1px 1px 3px rgba(255, 90, 0, 0.3)' }}>
          🎉 놓치지 마세요! 특별한 혜택이 기다립니다!
        </h1>
        <p className="hero-description" style={{ fontSize: '1.1rem', color: '#333', lineHeight: '1.5', marginBottom: '30px' }}>
        ...
        <button 
          ...
          onMouseEnter={e => {
            e.currentTarget.style.backgroundColor = '#ff784e';
        ...
        <div className="features" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', paddingTop: '20px' }}>
